...
1. **Contextualises the topic** — Shows you understand the broader significance
2. **Defines key terms** — Especially for abstract or multi-dimensional questions
3. **Sets the direction** — Signals to the examiner what the answer will cover
4. **Hooks attention** — A quote, statistic, recent event, or sharp observation
...
**Structure 1 — Statistic + Context:**
Open with a data point, then connect it to the question's theme.

**Structure 2 — Quote + Relevance:**
One line from a relevant thinker or constitutional provision, then explain why it applies.

**Structure 3 — Recent Event + Analysis:**
Reference a current affair related to the topic, then zoom out to the broader issue.
